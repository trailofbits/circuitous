...
test_mov = {
  ...
  .case(DE = MS().RDX(0x12).RIP(0x1005), R = True)
  .case(DE = MS().RDX(0x12000000).RIP(0x1005), R = False)
  .case(DE = MS().RDX(0x13).RIP(0x1005), run_bytes = "ba13000000", R = True)
  .case(
    I = S(0x0).RIP(0x1000),
  ...
  .tags({"min", "mov"})
  .DI(S(0x100).RAX(0x42).RBX(0x42).RCX(0x42).RDX(0x42))
  .case("mov rax",
