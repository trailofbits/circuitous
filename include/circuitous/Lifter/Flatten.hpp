...
namespace circ
{
    struct Flattener
    {
        ...
        Flattener( llvm::Function *func, llvm::Function *error ) :
        ...
        using ret_to_val_t = std::unordered_map< llvm::ReturnInst *, llvm::Value * >;
        void HandleReturns( const ret_to_val_t &ret_vals )
        {
