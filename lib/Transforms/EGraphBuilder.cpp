...
namespace circ
{
    ...
    node_template node_template_builder::visit(OutputSyscallReg *op) {
        return sized(op);
    }

    node_template node_template_builder::visit(InputSyscallReg *op) {
        return sized(op);
    }

    node_template node_template_builder::visit(SyscallModule *op) {
        return sized(op);
    }
