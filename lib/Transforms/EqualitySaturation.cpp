...
namespace circ {
    ...
    CircuitPtr EqualitySaturation(CircuitPtr &&circuit, std::span<RuleSet> rules) {
...
//     // // auto root     = runner.node(circ.get());
//     // auto ptr_size = circ->ptr_size;

//     // // circuit_egraph egraph = runner.get_graph();

//     // auto ext = circuit_extractor(
//     //   make_optimal_circuit_graph_view(std::move(egraph))
//     // );

//     // return extract_postprocess(ext.extract(ptr_size));
//     return circ;
//   }
