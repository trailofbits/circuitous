...
namespace circ
{
        ...
        -> std::tuple< lifted_operands_t, writes_t >
    {
        ...
        {
            log_info() << log_prefix() << "Lifting operand:" << i;
    ...
    auto mux_heavy_lifter::gather_final_values( unit_t &unit,
    ...
    auto mux_heavy_lifter::finalize_circuit() -> exalted_values_t
    {
        return {};
    }
}  // namespace circ
